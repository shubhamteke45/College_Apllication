package com.example.college_application.faculty;
...
import com.example.college_application.R;
...
public class AddTeachers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select category", "CSE&IT", "MECH", "CIVIL", "Elec", "other"};
