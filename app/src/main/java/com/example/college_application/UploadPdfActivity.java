...
public class UploadPdfActivity extends AppCompatActivity {
    ...
    private void uploadPdf() {
        ...
        pd.show();
        StorageReference sr = storageReference.child("pdf/"+pdfName+"-"+System.currentTimeMillis()+".pdf");
        sr.putFile(pdfData).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            @Override
